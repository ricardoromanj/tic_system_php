<form class="form-inline" role="form" action="<? $_PHP_SELF ?>" method="POST">
	...
	<input type="hidden" id="phonetutor_edit" name="phonetutor_edit" value="phonetutor_edit">
	<input type="hidden" id="phonetutor_id" name="phonetutor_id" value="<?= $phonetutor_row['phonetutor_id'] ?>">
